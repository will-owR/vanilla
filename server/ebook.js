...
function generateEbookHTML(poems) {
  ...
  <head>
    ...
    <style>
      ...
      .content { position: relative; z-index: 2; padding: 28mm 20mm; display:flex; flex-direction:column; justify-content:center; height:100%; font-family: 'Times New Roman', serif; color:#0b1220 }
